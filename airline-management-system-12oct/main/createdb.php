...
$sql="INSERT INTO airline_system.admin_info (admin_id,password) VALUES ('admin','$hashed_paswd')";
...
$sql="INSERT INTO airline_system.flights (type_of_flight,flight_no,source,destination,intermediate_stops,date_of_journey,departure_time,arrival_time,type_of_class,meal,amount,discount,flight_status) VALUES ('Domestic', '911', 'Delhi' , 'Mumbai' , '1-stop-jaipur', '2021-10-20', '20:44:00', '23:44:00' , 'Economy' , 'Veg/Non-veg' , '5700', '20', 'On-time')";
...
$sql="INSERT INTO airline_system.flights (type_of_flight,flight_no,source,destination,intermediate_stops,date_of_journey,departure_time,arrival_time,type_of_class,meal,amount,discount,flight_status) VALUES ('International', '423', 'Los angeles' , 'Singapore' , 'Non-stop', '2021-11-14', '18:22:00', '22:56:00' , 'Buisness' , 'Veg/Non-veg' , '23800', '10', 'On-time')";
