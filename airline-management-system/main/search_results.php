    ...
    <a href="index.html" class="logo me-auto"><img src="assets_welcome_page/img/iitdh_logo.png" alt="" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="passenger_login_signup/passenger_login.php">Book now</a></li>
          ...
          <li><a class="getstarted scrollto" href="passenger_login_signup/passenger_login.php">Login/Signup</a></li>
        </ul>
...
?>
                                      ...
                                      <a href="login.php" onClick="return confirm('Please login/signup first in order to make booking .')">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="passenger_login_signup/passenger_login.php">Login/Signup</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#about">About us</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="passenger_login_signup/passenger_login.php">Book Now</a></li>
